...
export function getCachedDashboardIndicators<T>(
...
export function setCachedDashboardIndicators(
  municipalityId: string,
  data: unknown,
) {
...
export function getCachedOperationalChecklist<T>(
  municipalityId: string,
): T | null {
...
export function setCachedOperationalChecklist(
  municipalityId: string,
  data: unknown,
) {
